...
pheatmap(as.matrix(dados_cluster), 
         cluster_rows = FALSE,  # Não agrupar as linhas
         cluster_cols = FALSE,  # Não agrupar as colunas
         border_color = NA,     # Remover bordas
         color = colorRampPalette(c("blue", "white", "red"))(100),  # Esquema de cores personalizado
