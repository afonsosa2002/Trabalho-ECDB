...
dados_heatmap <- dados_patient_limpo[, c("Diagnosis.Age", "Overall.Survival..Months.")]

# Remover linhas com valores NA se existir
dados_heatmap <- na.omit(dados_heatmap)

# Calcular a matriz de correlação
correlation_matrix <- cor(dados_heatmap)

# Criar o heatmap usando heatmaply
